          ...
          return (
            <React.Fragment>
              ...
              <div className=" recipe-container-sm  mx-auto d-block d-md-none">
                <Col>
                <div class='media'>
            <img class='d-flex recipe-img-sm mr-3' src='img/food1.jpg' >
            <div class='media-body mt-2'>
              <a href='#' class='text-dark'><h5>Recipe 1</h5></a>
              <p>There will be a brief description here</p>
              <a href='#' class='favorite-butt' role='button'><i class="fa fa-star"></i>  Favorite</a>
            </div></Col>
              </div>
            </React.Fragment>
          );
